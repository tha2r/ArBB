...
\*******************************************************************/
#
#    Private Messages Function File started
#

/*
        File name       -> functions_pm.php
...
//#
           ...
           function next_page($fid,$num,$perpage)
           {
            ...
            if($pages > 1)
            {
               ...
               {
               $pages_table.="<td class=\"td2\"><a href=\"pm.php?folder=$fid&page=1\">&nbsp;<< $lang[first]&nbsp;</a></td>";
               }
               if($page!=$ppages['first'])
               {
                       ...
                       if(($page-2)>=$ppages['first'])
                       {
                               ...
                               if($pppage['1']>0)
                               {
               $pages_table.="<td class=\"td2\">&nbsp;&nbsp;<a href=\"pm.php?folder=$fid&page=$pppage[1]\">$pppage[1]</a></td>";
                               }
                               if($pppage['2']>0)
                               {
               $pages_table.="<td class=\"td2\">&nbsp;<a href=\"pm.php?folder=$fid&page=$pppage[2]\">$pppage[2]</a>&nbsp;</td>";
                                  }
               ...
               {
               $pages_table.="<td class=\"td2\"><a href=\"pm.php?folder=$fid&page=$ppages[last]\">&nbsp;$lang[last] >>&nbsp;</a></td>";
               }
            $pages_table.="
                </tr>
               </table>";
