...
/*
        File name       -> functions_forumdisplay.php
...
die("<title>ArBB</title>\nYou Cant Access This File !!\n<br>\nArBB");
           ...
           function mark_forums_read($forumid = -1)
           {
                   ...
                   else
                   {
                           ...
                           {
                                   $return_url = 'forumdisplay.php?' . 'f=' . $arbb->forumcache["$forumid"]['mainid'];
...
//#
//#        Function next_page for multible pages in forumdisplay.php
//#
           ...
           function next_page($forumid,$threadnum,$perpage)
           {
            ...
            if($pages > 1)
            {
               ...
               $pages_table="
               <table class=\"table_border\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse: collapse\">
                <tr class=\"smallfont\" align=center>
                    <td class=\"nav_button\">$lang[page] $page $lang[of] $pages</td>
                    ";
               ...
               {
               $pages_table.="<td class=\"td2\"><a href=\"forumdisplay.php?fid=$fid&page=1&pp=$pp&sort=$sortfield&order=$sortorder\">&nbsp;<< $lang[first]&nbsp;</a></td>";
               }
               if($page!=$ppages['first'])
               {
                       ...
                       if(($page-2)>=$ppages['first'])
                       {
                               ...
                               if($pppage['1']>0)
                               {
               $pages_table.="<td class=\"td2\" width=\"15\"><a href=\"forumdisplay.php?fid=$fid&page=$pppage[1]&pp=$pp&sort=$sortfield&order=$sortorder\">$pppage[1]</a></td>";
                               }
                               if($pppage['2']>0)
                               {
               $pages_table.="<td class=\"td2\" width=\"15\"><a href=\"forumdisplay.php?fid=$fid&page=$pppage[2]&pp=$pp&sort=$sortfield&order=$sortorder\">$pppage[2]</a></td>";
                                  }
               ...
               {
               $pages_table.="<td class=\"td2\"><a href=\"forumdisplay.php?fid=$fid&page=$ppages[last]&pp=$pp&sort=$sortfield&order=$sortorder\">&nbsp;$lang[last] >>&nbsp;</a></td>";
               }
            $pages_table.="
                </tr>
               </table>";
