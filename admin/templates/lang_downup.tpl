<p><br></p>
	...
	<form action="lang.php?do=download&sid=$sid" method="post">
<table class="table_border" cellpadding="6" cellspacing="1" border="0" width="95%" align="center">
	...
	<tr class="td1">
		<td>$lang[language]</td>
		<td><select name="langid">$langselect</select></td>
			</tr>
	<tr class="td1">
		<td>$lang[filename]</td>
		<td>
        <input type="text" size="40" name="filename" value="arbb-language.xml"></td>
			</tr>
...
<br>
<form action="lang.php?do=upload" enctype="multipart/form-data" method="post">
<table class="table_border" cellpadding="6" cellspacing="1" border="0" width="95%" align="center">
	<tr class="tcat">
	<td colspan="2">
	$lang[upload]</td>
	...
	<tr class="td1">
		...
		<td>
        <input type="text" size="40" name="langtitle"></td>
			</tr>
	<tr class="thead" align="center">
		<td width="50%">
