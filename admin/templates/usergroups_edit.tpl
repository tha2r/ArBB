<p><br>
&nbsp;</p>
<form action="usergroups.php?sid=$sid&do=do_edit" name="cpugpform" method="post">
  <input type="hidden" value="$ug[usergroupid]" name="groupid">
      <table class="table_border" cellSpacing="1" cellPadding="6" width="100%" border="0">
        <tr>
          <td class="tcat" align="middle" colSpan="2">$lang[edit]
          : $ug[title]</td>
        </tr>
        <tr>
          <td class="td1" vAlign="top" width="40%">$lang[usersgroup_title]</td>
          <td class="td1" vAlign="top" width="60%">
          <input type="text" size="40" name="title" value="$ug[title]"></td>
        </tr>
        <tr>
          <td class="td1" vAlign="top" width="40%">$lang[usersgroup_description]</td>
          <td class="td1" vAlign="top" width="60%">
          <textarea name="description" rows="4" cols="28">$ug[description]</textarea></td>
        </tr>
        <tr>
          <td class="td1" vAlign="top" width="40%">$lang[users_title]<br><font class="smallfont">$lang[user_title_desc]</font></td>
          <td class="td1" vAlign="top" width="60%">
          <input type="text" size="40" name="usertitle" value="$ug[usertitle]"></td>
        </tr>
        <tr>
          <td class="td1" vAlign="top" width="40%">$lang[users_name_html]<br><font class="smallfont">$lang[users_name_html_note]</font></td>
          <td class="td1" vAlign="top" width="60%">
          <input type="text" size="15" name="opentag" value="$ug[opentag]">&nbsp;
          <input type="text" size="15" name="closetag" value="$ug[closetag]"></td>
        </tr>
  </table><br>
      <table class="table_border" cellSpacing="1" cellPadding="6" width="100%" border="0">
        <tr>
