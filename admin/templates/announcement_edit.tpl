...
<input type="hidden" name="aid" value="$an[aid]">
<table class="table_border" cellpadding="4" cellspacing="1" border="0" width="95%" align="center">
    ...
    <tr class="td1">
		...
		<td>
        <input type="text" size="35" name="title" value="$an[title]"></td>
    </tr>
    <tr class="td1">
...
<input type="text" name="endyear" size="5" value="$endyear"></td>
    ...
    <tr class="td1">
		...
		<td><textarea rows="5" cols="40" name="text">$an[announcement]</textarea></td>
    </tr>
	<tr class="thead">
