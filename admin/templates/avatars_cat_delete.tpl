<form action="avatars.php?do=do_delete_album&sid=$sid&catid=$cat[catid]" method="post">
<table class="table_border" cellSpacing="1" cellPadding="4" width="95%" align="center" border="0">
    <tr class="tcat">
      <td width="100%" colspan="2" aliogn="center">$lang[delete] : (<b>$cat[title]</b>)</td>
    </tr>
    <tr class="td1">
      <td width="100%" colspan="2">$lang[delete_confirm]<font color="#FF0000"> <b>$cat[title]</b></font> ..<br>
