<form action="forums.php?do=do_delete_mod&modid=$mod[modid]" method="post">
<table class="table_border" cellSpacing="1" cellPadding="4" width="95%" align="center" border="0">
    <tr class="tcat">
      <td width="100%" colspan="2" aliogn="center">$lang[delete_moderator] : $mod[username] - $lang[from] : $mod[title]</td>
    </tr>
    <tr class="td1">
      <td width="100%" colspan="2">$lang[delete_confirm]<font color="#FF0000"> <b>$mod[username]</b></font> .. $lang[from] $mod[title]<br>
