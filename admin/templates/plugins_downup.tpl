	...
	<form action="plugins.php?do=download&sid=$sid" method="post">
<table class="table_border" cellpadding="6" cellspacing="1" border="0" width="95%" align="center">
	...
	<tr class="td1">
		<td>$lang[filename]</td>
		<td>
        <input type="text" size="40" name="filename" value="arbb-plugins.xml"></td>
			</tr>
...
<br>
<form action="plugins.php?do=upload" enctype="multipart/form-data" method="post">
<table class="table_border" cellpadding="6" cellspacing="1" border="0" width="95%" align="center">
	<tr class="tcat">
	<td colspan="2">
	$lang[upload]</td>
