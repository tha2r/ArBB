...
<table class="table_border" cellpadding="4" cellspacing="1" border="0" width="95%" align="center">
    ...
    <tr class="td1">
                ...
                <td><textarea rows="5" cols="40" name="phpcode"></textarea></td>
    </tr>
    <tr class="td1">
                <td>$lang[plugins_active]</td>
                <td><input type="radio" name="active" value="1" checked> $lang[yes]&nbsp;&nbsp; <input type="radio" name="active" value="0">$lang[no]</td>
    </tr>
        <tr class="thead">
