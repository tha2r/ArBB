...
<input type="hidden" name="id" value="$bb[bid]">
<table class="table_border" cellpadding="4" cellspacing="1" border="0" width="95%" align="center">
	...
	<tr class="td1">
		...
		<td><input type="text" name="tag" size="30" value="$bb[tag]"></td>
    </tr>
    <tr class="td1">
		<td>$lang[replacement]</td>
		<td>
        <textarea name="replacement" id="bbcode_replacement" rows="5" cols="50">$bb[replacement]</textarea>
    ...
    <tr class="td1">
		<td>$lang[example]</td>
		<td><input type=text name="example" size="30" value="$bb[example]"></td>
    </tr>
    <tr class="td1">
		<td>$lang[explanation]</td>
		<td>
		<textarea name="explanation" id="bbcode_explanation" rows="5"  cols="50">$bb[explanation]</textarea>
    ...
    <tr class="td1">
		...
		<td>
		<select name="parms" style="width:200">
    ...
    <tr class="td1">
		...
		<td><input type=text name="image" size="30" value="$bb[image]"></td>
    </tr>
	<tr class="thead">
      <td width="100%" align="center" colspan="2">
      <input type="submit" name="add" value="   -    $lang[update]   -   " size="30"></td>
	</tr>
    </table>
    &nbsp;</form>
<div align="center">
