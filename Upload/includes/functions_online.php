...
\*******************************************************************/
#
#    Online Function File started
#

/*
        File name       -> functions_online.php
...
//#
           ...
           function next_page($num,$perpage)
           {
            ...
            if($pages > 1)
            {
               ...
               {
               $pages_table.="<td class=\"td2\"><a href=\"online.php?page=1&pp=$pp\">&nbsp;<< $lang[first]&nbsp;</a></td>";
               }
               if($page!=$ppages['first'])
               {
                       ...
                       if(($page-2)>=$ppages['first'])
                       {
                               ...
                               if($pppage['1']>0)
                               {
               $pages_table.="<td class=\"td2\" width=\"15\"><a href=\"online.php?page=$pppage[1]&pp=$pp\">$pppage[1]</a></td>";
                               }
                               if($pppage['2']>0)
                               {
               $pages_table.="<td class=\"td2\" width=\"15\"><a href=\"online.php?page=$pppage[2]&pp=$pp\">$pppage[2]</a></td>";
                                  }
               ...
               {
               $pages_table.="<td class=\"td2\"><a href=\"online.php?page=$ppages[last]&pp=$pp\">&nbsp;$lang[last] >>&nbsp;</a></td>";
               }
            $pages_table.="
                </tr>
               </table>";
